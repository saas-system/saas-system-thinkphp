...
class PlatformAdminTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table->addColumn('username', 'string', ['limit' => 20, 'null' => false, 'default' => '', 'comment' => '用户名'])
            ...
            ->addColumn('mobile', 'string', ['limit' => 20, 'null' => false, 'default' => '', 'comment' => '手机'])
            ->addColumn('login_failure', 'integer', ['limit' => 1, 'null' => false, 'default' => 0, 'comment' => '登录失败次数'])
            ->addColumn('last_login_time', 'integer', ['null' => true, 'signed' => false, 'comment' => '登录时间'])
        ...
        // 管理员日志
        $table = $this->table('platform_admin_log', ['collation' => 'utf8mb4_unicode_ci', 'comment' => '平台 - 管理员日志表']);
