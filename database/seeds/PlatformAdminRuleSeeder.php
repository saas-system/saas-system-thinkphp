            ...
            [
                ...
                'sublist'   => [
                    ...
                    [
                        ...
                        'weigh'     => 120,
                        'status'    => 1,
                        'sublist'   => MenuService::getCommonMenuData('tenant/admin', ['index', 'add', 'edit', 'del', 'autoLogin']),
                    ],
                    [
                        'type'      => 'button',
                        'title'     => '租户配置',
                    ...
                    [
                        ...
                        'path'      => 'tenant/businessAdmin',
                        'icon'      => 'fa fa-user-circle',
                        'menu_type' => 'tab',
                        'url'       => '',
                        'component' => '/src/views/backend/tenant/businessAdmin/index.vue',
                        'keepalive' => 1,
                        'extend'    => 'none',
                        'remark'    => '',
                        'weigh'     => 125,
                        'status'    => 1,
                        'sublist'   => MenuService::getCommonMenuData('tenant/businessAdmin'),
                    ],
                ],
            ],
            // 3. 权限管理
